...
/* WEBPACK VAR INJECTION */(function(setImmediate) {window.$ = __webpack_require__(0);
...
(function ($) {
    jQuery.fn.curvedImage = function (options) {
        ...
        var make = function make(t) {
            ...
            //
            // };
            t.curvedImage = {};t.curvedImage.options = options;
            console.log(img);
        };

        var maked = function maked(t) {
            console.log('maked');
        };
