...
var blob = function blob() {
    $('.blob').each(function (index) {
        var t = $(this);
        var pos = $('.hover-blob').offset();
        var posX = pos.left + $(this).position().left + 25;
        var posY = pos.top + $(this).position().top + 25;
        var pageX = cursore.pageX < 0 ? -1 * cursore.pageX : cursore.pageX;
        var pageY = cursore.pageY < 0 ? -1 * cursore.pageY : cursore.pageY;
        var disX = posX - pageX;
        var disY = posY - pageY;
        var disXn = 0;
        var disYn = 0;
...
$('.header__link').hover(function () {
    ...
    var colorT = $($('.blob')[0]).css('background-color');
    var index = colors.indexOf(colorT);
    ...
    $('.blob').each(function () {
        var t = $(this);
        var pos = t.offset();
        var posX = pos.left - 25;
        var posY = pos.top - 25;
        var disX = posX - cursore.pageX;
        var disY = posY - cursore.pageY;
